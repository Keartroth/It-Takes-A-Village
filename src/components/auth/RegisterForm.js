...
export const RegisterForm = ({ toggle }) => {
    ...
    return (
        <section className="mainContainer__registration">
            <div className="registration__column--left"></div>
            <div className="registration__container">
                <Container>
                    <Form onSubmit={handleRegister}>
                        ...
                        <Button variant="primary" type="submit" id="registration--button">
                            Submit
                        </Button>
                    </Form>
                </Container>
            </div>
            <div className="registration__column--right"></div>
        </section>
    )
}